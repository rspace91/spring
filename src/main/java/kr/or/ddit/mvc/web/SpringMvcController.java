...
import kr.or.ddit.mvc.util.FileUtil;
...
public class SpringMvcController {
	...
	public String requestPath(@PathVariable(name = "subpath") String subpath) {
		logger.debug("subPath : P{}", subpath);
		return "mvc/view";
	}
	...
	public String upload(String userId, 
		...
		//업로드되는 시점의 년/월 폴더를 생성해주고, 파일경로와 파일정보를 FileInfo 객체에 담아 리턴
...
//		session.setAttribute("userId", userId);
	...
	public String responseStatus() throws NoFileException {
		...
		//	 NotFileException에 설정한 @ResponseStatus에 의해
	...
	@RequestMapping("/ioFileException")
